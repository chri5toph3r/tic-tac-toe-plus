...
surf2 = pg.Surface((40, 40), pg.SRCALPHA)
pg.draw.circle(surf2, 'red', (20, 20), 15, 5)
circle = pg.cursors.Cursor((20, 20), surf2)

# cursors list
cursors = [system, bitmap_1, bitmap_2, color, circle]
cursor_index = 0
